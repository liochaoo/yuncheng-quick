...
VALUES
    ...
    (100000000000000117, 100000000000000110, 'BUTTON', '导出用户', NULL, NULL,
     NULL, NULL, 'system:user:export', 70, NULL, 0, CURRENT_TIMESTAMP(3), 0, CURRENT_TIMESTAMP(3), 0),
    ...
    (100000000000000204, 100000000000000200, 'BUTTON', '删除组织', NULL, NULL,
     ...
     CURRENT_TIMESTAMP(3), 0, CURRENT_TIMESTAMP(3), 0),
    (100000000000000205, 100000000000000200, 'BUTTON', '导出组织', NULL, NULL,
     NULL, NULL, 'system:organization:export', 50, NULL, 0,
     CURRENT_TIMESTAMP(3), 0, CURRENT_TIMESTAMP(3), 0),
